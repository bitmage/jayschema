...
// ******************************************************************
// [deprecated] Backward compatibility with v0.1.x
// ******************************************************************
Validator.loaders = { http: require('./httpLoader.js') };
...
// ******************************************************************
Validator.prototype.getMissingSchemas = function() {
...
// ******************************************************************
Validator._getObjectHash = function(obj) {
...
// ******************************************************************
Validator.prototype._loadMissingRefs = function(depth, callback) {
  var err;
...
// ******************************************************************
Validator.prototype._validateImpl = function(instance, schema, resolutionScope,
  instanceContext)
{
  // for schemas that have no id, use an internal anonymous id
  var schemaId = schema.id || resolutionScope ||
    ANON_URI_SCHEME + '://' + Validator._getObjectHash(schema) + '/#';
...
Validator.prototype.validate = function(instance, schema, callback)
{
  ...
  var schemaId = schema.id || ANON_URI_SCHEME + '://' +
    Validator._getObjectHash(schema) + '/#';
